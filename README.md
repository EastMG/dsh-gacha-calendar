...
| [`gacha-calendar-core`](packages/core) | 平台中立的抓取核心：`createEngine({ transport, storage, now })`，零依赖、零宿主依赖 | 其它平台
浏览器插件［`gacha-calendar-extension`］(https://github.com/EastMG/gacha-calendar-extension) 等 开发中 |
