			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 6, border: "1px solid var(--dsw-alias-border-l1)", borderRadius: 10, padding: "12px 14px", background: "var(--dsw-alias-bg-layer-1)" }, children: [
						...
						(0, react_jsx_runtime.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 11, marginBottom: 2 }, children: "\u53D6\u6D88\u201C\u5C55\u793A\u201D\u53EF\u9690\u85CF\u6761\u76EE\uFF1B\u201C\u81EA\u5B9A\u4E49\u201D\u53EF\u8986\u76D6\u722C\u53D6\u5730\u5740\uFF1B\u5220\u9664\u540E\u53EF\u201C\u6062\u590D\u9ED8\u8BA4\u6761\u76EE\u201D\u8FD8\u539F\u3002" }),
						sorted.map((g) => {
							const mode = entryUrlMode(g.id);
							return (0, react_jsx_runtime.jsxs)("div", {
								style: { display: "flex", alignItems: "center", gap: 8, padding: "4px 0", borderBottom: "1px solid var(--dsw-alias-border-l1)", flexWrap: "wrap" },
								key: g.id,
								children: [
									(0, react_jsx_runtime.jsx)("img", { src: g.icon, alt: g.name, style: { width: 22, height: 22, borderRadius: 5, objectFit: "cover" } }),
									(0, react_jsx_runtime.jsx)("span", { style: { flex: "0 1 auto", minWidth: 90, fontWeight: 600 }, children: g.name }),
									(0, react_jsx_runtime.jsxs)("label", { style: { ...labelStyle, cursor: "pointer" }, children: [
									...
									(0, react_jsx_runtime.jsxs)("select", {
										...
										children: [
											(0, react_jsx_runtime.jsx)("option", { value: "default", children: "\u9ED8\u8BA4\u5730\u5740" }),
									...
									(0, react_jsx_runtime.jsx)("button", { type: "button", className: "gacha-cal-sort-btn", style: { marginLeft: "auto" }, onClick: () => removeEntry(g), children: "\u5220\u9664" })
								]
							});
						}),
