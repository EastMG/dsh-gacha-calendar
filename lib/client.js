window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const STYLE = `
			...
			/* 时间列（卡池起止/活动起止，第 4/6 列）：等宽数字 + 居中，使不同位数的倒计时左右对齐 */
			.gacha-cal-row > :nth-child(4), .gacha-cal-row > :nth-child(6) { text-align: center; font-variant-numeric: tabular-nums }
			.gacha-cal-h > :nth-child(4), .gacha-cal-h > :nth-child(6) { text-align: center }
