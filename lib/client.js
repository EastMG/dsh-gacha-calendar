						...
						sorted.map((g, i) => {
							...
							return (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									// 活动来源列（有活动源可切换/自定义；无活动源默认进入"自定义"输入，可直接填地址）
									(0, react_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, justifySelf: "center", minWidth: 0 }, children: [
										evKind === "independent" ? (0, react_jsx_runtime.jsxs)("select", {
											...
											(0, react_jsx_runtime.jsx)("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 11, flex: "none" }, children: "自定义" }),
											(0, react_jsx_runtime.jsx)("input", {
												type: "text",
												placeholder: "活动源地址（MediaWiki api.php，可选）",
