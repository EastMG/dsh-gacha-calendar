window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region styles
		const STYLE = `
			.gacha-cal-btn{display:flex;align-items:center;gap:8px;width:100%;min-height:40px;padding:8px 10px;border:none;background:transparent;color:var(--dsw-alias-label-primary);border-radius:10px;font-size:14px;line-height:22px;font-weight:400;cursor:pointer;box-sizing:border-box;white-space:nowrap;overflow:hidden;text-align:left}
